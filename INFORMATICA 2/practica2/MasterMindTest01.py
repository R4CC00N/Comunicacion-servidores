...
testGame = MasterMindGame("RBBB")

if testGame.secretCode != ['🔴', '🔵', '🔵', '🔵']:
    print("peeeeeeeeeee Error al crear una partida con una combinación concreta.")
else:
    print("peeeeeeeeee Correcto. Ha generado la clave secreta: " + str(['🔴', '🟢', '🔵', '⚫']) + " con la combinación que hemos pedido RGBK.")
